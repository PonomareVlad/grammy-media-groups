...
Deno.test("extractMessages returns empty for sendMediaGroup with non-array", () => {
...
Deno.test("extractMessages returns empty for boolean result (editMessage inline)", () => {
